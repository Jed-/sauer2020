...
bool printparticlesfull(int efocus, extentity &e, char *buf, int len) {
    switch(e.attr1) {
        case 0: case 4: case 7: case 8: case 9: case 10: case 11: case 12: case 13:
            nformatstring(buf, len, "\f2id:\f7 %d \f2pos(\f7%.2f, %.2f, %.2f\f2)\f7 %s(%d) %d %d %d 0x%.3hX %d", efocus, e.o.x, e.o.y, e.o.z, entities::entname(e.type), e.type, e.attr1, e.attr2, e.attr3, e.attr4, e.attr5);
            return true;
        case 3:
            nformatstring(buf, len, "\f2id:\f7 %d\f7 \f2pos(\f7%.2f, %.2f, %.2f\f2)\f7 %s(%d) %d %d 0x%.3hX %d %d", efocus, e.o.x, e.o.y, e.o.z, entities::entname(e.type), e.type, e.attr1, e.attr2, e.attr3, e.attr4, e.attr5);
            return true;
        case 5: case 6:
            nformatstring(buf, len, "\f2id:\f7 %d\f7 \f2pos(\f7%.2f, %.2f, %.2f\f2)\f7 %s(%d) %d %d 0x%.3hX 0x%.3hX %d", efocus, e.o.x, e.o.y, e.o.z, entities::entname(e.type), e.type, e.attr1, e.attr2, e.attr3, e.attr4, e.attr5);
            return true;
    }
    return false;
}
